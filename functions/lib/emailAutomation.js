...
exports.testWelcomeEmail = exports.retryFailedEmails = exports.onUserCreated = exports.processEventTriggeredEmail = exports.processScheduledEmails = void 0;
...
exports.testWelcomeEmail = functions.https.onCall(async (data, context) => {
    try {
        ...
        const welcomeSequence = sequences.find(seq => Array.isArray(seq.emails) && seq.emails.some(email => email.triggerEvent === 'user_registration'));
        if (!welcomeSequence) {
      ...
      `;
            ...
            const welcomeEmailIndex = welcomeSequence.emails.findIndex(email => email.triggerEvent === 'user_registration');
